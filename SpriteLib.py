...
textures[LASEREAGLE | YELLOW | NORMAL] = pygame.image.load("assets/graphics/elements/troops/lasereagle/yellow/normal.png")
...
textures[FLYINGTANK | YELLOW | NORMAL] = pygame.image.load("assets/graphics/elements/troops/flyingtank/yellow/normal.png")
...
textures[MINERALPILE] = pygame.image.load("assets/graphics/elements/environment/mineralpile.png")
...
layer_map[MINERALPILE] = GROUND_LAYER