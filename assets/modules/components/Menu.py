...
class Menu:
    ...
    Textures = {
        ...
        "TroopControl": pygame.image.load("assets/graphics/menu/troopcontrol.png"),
        "WorkerControl": pygame.image.load("assets/graphics/menu/workercontrol.png"),
    ...
    def __init__(self):
        ...
        self.control_mode = self.TROOPCONTROL
    ...
    def draw_controls(self, screen):
        if self.control_mode == self.TROOPCONTROL:
            screen.blit(self.Textures["TroopControl"], [30,90])
        elif self.control_mode == self.WORKERCONTROL:
            screen.blit(self.Textures["WorkerControl"], [30,90])
    ...
    def click_menu(self, size, location):
        ...
        if 30 < location[0] < 60:
            if 90 < location[1] < 120:
                if self.control_mode == self.TROOPCONTROL:
                    self.control_mode = self.WORKERCONTROL
                elif self.control_mode == self.WORKERCONTROL:
                    self.control_mode = self.TROOPCONTROL
                return self.CONTROL_SWITCH, None
            elif 120 < location[1] < 150:
                return self.CONTROL, None
            elif 150 < location[1] < 180:
                return self.CONTROL_RADIUS_UP, None
            elif 180 < location[1] < 210:
